/**
 * Tests for ProjectManager's per-ticket lock (withTicketLock) and the
...
// ---------------------------------------------------------------------------
// Minimal ProjectManager-style per-ticket lock — extracted for unit testing.
// This mirrors the implementation in project-manager.ts exactly.
// ---------------------------------------------------------------------------
...
// These test the patterns found in ProjectManager using simplified stubs.
// ---------------------------------------------------------------------------
...
describe('supervisor lifecycle races', () => {
  ...
  /**
   * Simulates ProjectManager's start/stop with the per-ticket lock.
   */
