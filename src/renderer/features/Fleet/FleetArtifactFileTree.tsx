  ...
  const handleClick = useCallback(() => {
    if (entry.isDirectory) {
      if (!expanded && children === null) {
        void fleetApi.listArtifacts(ticketId, entry.relativePath).then(setChildren);
      }
...
type FleetArtifactFileTreeProps = {
...
export const FleetArtifactFileTree = memo(({ entries, ticketId, selectedPath, onSelect }: FleetArtifactFileTreeProps) => {
  return (
...
FleetArtifactFileTree.displayName = 'FleetArtifactFileTree';
