 ...
 */
export const $pendingMigrationNotice = computed(persistedStoreApi.$atom, (store): PagesMigrationState | null => {
...
export const migrationApi = {
  ...
  cleanupLegacy: (): Promise<{ removed: number }> => emitter.invoke('migration:cleanup-legacy-pages'),
};
