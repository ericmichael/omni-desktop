...
setSandboxValue('');
  ...
  }, [isValid, isSubmitting, isEdit, editProject, label, linkRepo, sourceKind, workspaceDir, repoUrl, defaultBranch, sandboxMode, sandboxValue, dueDate, onClose]);
      ...
      <AnimatedDialog open={open} onClose={onClose}>
        <DialogContent className="max-w-md">
          ...
          <DialogBody className={styles.body}>
            ...
            {/* Link a directory toggle. Existing git-remote projects keep
                their source intact on submit — the UI only offers local. */}
            {!linkRepo && (
              <button
                type="button"
